...
- Replace `andriy-chornyy` with your Github username in the [DEMO LINK](https://andriy-chornyy.github.io/react_movies-list-js/) and add it to the PR description.
