...
> DON'T use Typescript in this task
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://kseniia-chepur.github.io/react_movies-list-js/) and add it to the PR description.
