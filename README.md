...
1. Render movies from a given `moviesFromServer` array (for the simplicity, you can do it inside the `App` and split
   later).
...
- Replace `<your_account>` with your Github username in
  the [DEMO LINK](https://VasulenkoIllia.github.io/react_movies-list-js/) and add it to the PR description.
