...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://github.com/NataKovbasniuk/react_movies-list-js.git) and add it to the PR description.
