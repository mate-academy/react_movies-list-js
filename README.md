...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Roman-Bilichenko.github.io/react_movies-list-js/) and add it to the PR description.
