...
- Open one more terminal and run tests with `npm test` to ensure your solution is corrrect.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ilyapgitt.github.io/react_movies-list-js/) and add it to the PR description.
