...
- Replace `andrewsiemakin` with your Github username in the [DEMO LINK](https://andrewsiemakin.github.io/react_movies-list-js/) and add it to the PR description.
